    ...
    tabItems(
      ...
      tabItem(tabName = "ebc",
              ...
              box(
                ...
                fluidRow(
                  splitLayout(cellWidths = c("100%"),  fluidRow(
                    column(width = 6,
                           plotOutput("ebc_plot")
                    ),
                    column(width = 6,
                           plotOutput("ebc_plot2")
                    )
                  )
      ...
      tabItem(tabName = "download",
              h2("Download Data"),
              actionButton("download_data", "Download Normalize Results"),
              actionButton("download_data2", "Download Diffrential Expression Results"),
              actionButton("download_data3", "Download EBC Results"),
              actionButton("download_data4", "Download Generate Results")
